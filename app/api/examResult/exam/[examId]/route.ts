...
export async function GET(
  ...
  try {
    ...
    const { studentId, grade, page = 1, limit = 10, sortBy = 'totalScore', sortOrder = 'desc' } = validatedQuery;
    ...
    return NextResponse.json(
      { success: false, message: '시험별 결과 조회 중 오류가 발생했습니다.' },
      { status: 500 }
    );
  }
}
